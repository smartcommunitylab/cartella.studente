...
export class AddCertificationPage implements OnInit {
  ...
  ngOnInit():void {
      ...
      if (certification!=null){
        ...
        this.certification = JSON.parse(this.params.get('certification')).attributes as Certification;
        this.certificate=this.experienceContaniner.certificate as Certificate;
